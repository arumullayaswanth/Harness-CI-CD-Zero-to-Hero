# ============================================
# EKS Auto Mode (Production Level)
# Based on: github.com/setheliot/eks_auto_mode
# ============================================
...
# Node IAM Role (trusted by BOTH ec2 AND eks)
...
# Node role policies (required for Auto Mode nodes)
...
resource "aws_eks_cluster" "main" {
  ...
  # Auto Mode networking (load balancers)
